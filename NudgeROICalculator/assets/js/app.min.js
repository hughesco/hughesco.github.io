...
var arr1xE8G8=new Array(1);for(var ii=0;ii<1;ii++){arr1xE8G8[ii]=new Array(3);for(var jj=0;jj<3;jj++){arr1xE8G8[ii][jj]=0}};var arr1xE17J17=new Array(1);for(var ii=0;ii<1;ii++){arr1xE17J17[ii]=new Array(6);for(var jj=0;jj<6;jj++){arr1xE17J17[ii][jj]=0}};var arr1xE40E44=new Array(5);for(var ii=0;ii<5;ii++){arr1xE40E44[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr1xE40E44[ii][jj]=0}};var eecm1=new Array(new Array(arr1xE8G8,0,0,0,2));function calc(data){arr1xE8G8[0][2]=data['XLEW_1_8_7'];arr1xE8G8[0][1]=data['XLEW_1_8_6'];arr1xE8G8[0][0]=data['XLEW_1_8_5'];var c1H8=(sumgeneral(3,0,0,eecm1));var c1I8=(arr1xE8G8[0][2]);data['XLEW_1_8_9']=c1I8;data['XLEW_1_8_8']=c1H8;};
...
function recalc_onclick(ctl) {ssc.recalcSource = ctl;
  if (true) {
co['XLEW_1_8_5']=eeparseFloat(document.getElementById('XLEW_1_8_5').value);co['XLEW_1_8_6']=eeparseFloat(document.getElementById('XLEW_1_8_6').value);co['XLEW_1_8_7']=eeparseFloat(document.getElementById('XLEW_1_8_7').value);calc(co);if(ssc !== undefined && ssc.realtimesync !== undefined && ssc.realtimesync.connection !== undefined && ssc.realtimesync.connection.readyState == 1){ssc.realtimesync.coUpdate(co,ctl);}else if(ssc !== undefined && ssc.realtimesync !== undefined && ssc.realtimesync.wsUrl && ssc.realtimesync.IsCloseByError && !ssc.realtimesync.IsErrorMsgDialogShown){if(!alert('Realtime-sync is Disconnected, This Form will not save in server and will not collaborate with your partner.')){ssc.realtimesync.IsErrorMsgDialogShown = true;}}document.getElementById('XLEW_1_8_8').value=eedatefmt(fmtdate1,co['XLEW_1_8_8']);document.getElementById('XLEW_1_8_9').value=eedatefmt(fmtdate1,co['XLEW_1_8_9']);
};};
